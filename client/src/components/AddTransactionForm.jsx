...
const AddTransactionForm = ({ onAdd }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setForm({ type: "income", source: "", amount: "", tag: "", date: "" });
  };
  ...
  return (
    <div className="card add-form-card">
      ...
      <form onSubmit={handleSubmit} className="form-grid">
        ...
        <input name="amount" type="number" placeholder="Amount" value={form.amount} onChange={handleChange} min="0" />
        <input name="tag" placeholder="Tag (optional)" value={form.tag} onChange={handleChange} />
